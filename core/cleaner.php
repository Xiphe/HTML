...
class Cleaner {
	 ...
	 */
	public static function get_clean($str)
	{
		...
		switch (Config::get('cleanMode')) {
			case 'strong':
				$str = self::get_strong($str);
				break;
			case 'basic':
				$str = self::get_basic($str);
				break;
			default:
				return $str;
		}
	...
	public static function get_strong($str) {
		 ...
		 */
		return implode(Generator::get_lineBreak(), $r).Generator::get_lineBreak();
	}
